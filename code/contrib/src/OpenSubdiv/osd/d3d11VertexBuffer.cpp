...
OsdD3D11VertexBuffer::UpdateData(const float *src, int startVertex, int numVertices,
    ...
    ID3D11DeviceContext1 * pd3dDeviceContext =
        static_cast<ID3D11DeviceContext1*>(param);
...
ID3D11Buffer *
OsdD3D11VertexBuffer::BindD3D11Buffer(ID3D11DeviceContext1 *deviceContext) {

    return _buffer;
}

ID3D11UnorderedAccessView *
OsdD3D11VertexBuffer::BindD3D11UAV(ID3D11DeviceContext1 *deviceContext) {

    return _uav;
}

bool
OsdD3D11VertexBuffer::allocate(ID3D11Device1 *device) {
