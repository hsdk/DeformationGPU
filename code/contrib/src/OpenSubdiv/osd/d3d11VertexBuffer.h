...
public:
    ...
    ID3D11Buffer *BindD3D11Buffer(ID3D11DeviceContext1 *deviceContext);

    /// Returns the D3D11 UAV
    ID3D11UnorderedAccessView *BindD3D11UAV(ID3D11DeviceContext1 *deviceContext);
...
protected:
    ...
    bool allocate(ID3D11Device1 *device);
