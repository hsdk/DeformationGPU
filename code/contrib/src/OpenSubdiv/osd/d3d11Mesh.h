...
public:
	...
	virtual int GetNumPTexFaces() const{return _farMesh->GetNumPtexFaces();}
...
private:
    ...
    ID3D11DeviceContext1 *_pd3d11DeviceContext;
};
...
public:
	...
	virtual int GetNumPTexFaces() const{return _farMesh->GetPatchTables()->GetNumPtexFaces();}//return _farMesh->GetNumPtexFaces();}
