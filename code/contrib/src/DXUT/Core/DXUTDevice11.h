...
public:
	...
	{  
		return GetDeviceSettingsCombo(	pDeviceSettings->AdapterOrdinal,
										pDeviceSettings->sd.Format,
										pDeviceSettings->sdfs.Windowed ); 
	}
    //CD3D11EnumDeviceSettingsCombo*           GetDeviceSettingsCombo( DXUTD3D11DeviceSettings* pDeviceSettings ) { return GetDeviceSettingsCombo( pDeviceSettings->AdapterOrdinal,
	//																																			 pDeviceSettings->DriverType,
	//																																			 pDeviceSettings->Output,
	//																																			 pDeviceSettings->sd.Format,
	//																																			  pDeviceSettings->sdfs.Windowed ); }
#else
	//CD3D11EnumDeviceSettingsCombo*           GetDeviceSettingsCombo( DXUTD3D11DeviceSettings* pDeviceSettings ) { return GetDeviceSettingsCombo( pDeviceSettings->AdapterOrdinal,
	//																																			 pDeviceSettings->DriverType,
	//																																			 pDeviceSettings->Output,
	//																																			 pDeviceSettings->sd.BufferDesc.Format,
